...
describe "sum_of_3_or_5_multiples" do
  it "should return the sum of the integers multiple of 3 or 5" do
  ...
  it "should return Yo ! Je ne prends que les entiers naturels. TG when one of the element is NOT and integer or a multiple of 3 or 5" do
